...
@Component({
  selector: 'app-cotizacion-email',
  templateUrl: './cotizacion-email.component.html',
  styleUrls: ['./cotizacion-email.component.css']
})
export class CotizacionEmailComponent implements OnInit {
  ...
  constructor(public _MessageService: MessageService,private sanitizer: DomSanitizer, private _http: HttpClient,
    public dialogRef: MatDialogRef<CotizacionEmailComponent>,@Inject(MAT_DIALOG_DATA) public data: parametros) { }
