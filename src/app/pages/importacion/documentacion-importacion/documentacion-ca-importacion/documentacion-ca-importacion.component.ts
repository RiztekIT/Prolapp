...
@Component({
  ...
  templateUrl: './documentacion-ca-importacion.component.html',
  styleUrls: ['./documentacion-ca-importacion.component.css']
})
export class DocumentacionCAImportacionComponent implements OnInit {
  ...
  onAddDocumentos() {
    ...
    for (var l = 0; l < this.seleccionados.length; l++) {
      ...
      for (var i = 0; i < event.addedFiles.length; i++) {
        ...
        documento.Path = 'Documentos/CA/0/0/' + this.seleccionados[l].ClaveProducto + '/' + this.seleccionados[l].Lote + '/' + event.addedFiles[i].name;
