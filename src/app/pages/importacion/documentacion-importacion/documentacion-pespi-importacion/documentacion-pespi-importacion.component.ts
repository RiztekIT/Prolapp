...
@Component({
  ...
  templateUrl: './documentacion-pespi-importacion.component.html',
  styleUrls: ['./documentacion-pespi-importacion.component.css']
})
  ...
  onAddDocumentos() {
    ...
    for (var l = 0; l < this.seleccionados.length; l++) {
      ...
      for (var i = 0; i < event.addedFiles.length; i++) {
        ...
        documento.Path = 'Documentos/PESPI/0/0/' + this.seleccionados[l].ClaveProducto + '/' + this.seleccionados[l].Lote + '/' + event.addedFiles[i].name;
