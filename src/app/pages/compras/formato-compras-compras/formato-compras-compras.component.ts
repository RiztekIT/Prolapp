...
export class FormatoComprasComprasComponent implements OnInit {
  ...
  onAddDetalleCompra(form: NgForm) {
    ...
    } else if (this.PresentacionSelect == '50 Lb') {
      this.detalleCompra.PesoxSaco = '50';
    } else if (this.PresentacionSelect == '997.90 Kg') {
      this.detalleCompra.PesoxSaco = '997.9';
    } else if (this.PresentacionSelect == '22.68 Kg') {
  ...
  onAddDetalleCompraAdministrativa(form: NgForm) {
  ...
  onEditDetalleCompraAdministrativa(form) {
